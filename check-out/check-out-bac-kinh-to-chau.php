...
<div class="breadcrumb1">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">
                <a href="../bai-viet/chuong-trinh-tour-trung-quoc-thuong-hai-hang-chau-to-chau-bac-kinh.php">Thượng Hải - Hàng Châu - Tô Châu - Bắc Kinh</a>
            </li>
                        ...
                        <div class="inner">
                            ...
                            <div class="form-row">
                                <div class="form-holder form-holder-2">
                                    ...
                                    <input type="text" placeholder="" class="form-control input-step-2" id="name_tour" value="CHƯƠNG TRÌNH TOUR TRUNG QUỐC THƯỢNG HẢI – HÀNG CHÂU – TÔ CHÂU – BẮC KINH">
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-holder form-holder-2">
                            ...
                            <div class="form-row">
                                <div class="form-holder form-holder-2">
                                    ...
                                    <input type="text" placeholder="" class="form-control input-step-2-2" id="account_number" name="account_number" value="13990000">
                                </div>
                            </div>
