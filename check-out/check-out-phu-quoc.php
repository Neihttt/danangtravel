...
<div class="breadcrumb1">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">
                <a href="../bai-viet/phu-quoc-thien-duong-thao-ngoc.php">Tour Phú Quốc 3N2D: Phú Quốc Thiên Đường Đảo Ngọc</a>
            </li>
                        ...
                        <div class="inner">
                            ...
                            <div class="form-row">
                                <div class="form-holder form-holder-2">
                                    ...
                                    <input type="text" placeholder="" class="form-control input-step-2" id="name_tour" value="Tour Phú Quốc 3N2D: Phú Quốc Thiên Đường Đảo Ngọc">
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-holder form-holder-2">
                            ...
                            <div class="form-row">
                                <div class="form-holder form-holder-2">
                                    ...
                                    <input type="text" placeholder="" class="form-control input-step-2-2" id="account_number" name="account_number" value="3690000">
                                </div>
                            </div>
