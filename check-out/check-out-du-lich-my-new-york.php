...
<div class="breadcrumb1">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">
                <a href="../bai-viet/du-lich-my-bo-dong.php">DU LỊCH MỸ - BỜ ĐÔNG</a>
            </li>
                        ...
                        <div class="inner">
                            ...
                            <div class="form-row">
                                <div class="form-holder form-holder-2">
                                    ...
                                    <input type="text" placeholder="" class="form-control input-step-2" id="name_tour" value="DU LỊCH MỸ - BỜ ĐÔNG [NEW YORK - PHILADELPHIA - WASHINGTON D.C]">
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-holder form-holder-2">
                            ...
                            <div class="form-row">
                                <div class="form-holder form-holder-2">
                                    ...
                                    <input type="text" placeholder="" class="form-control input-step-2-2" id="account_number" name="account_number" value="57999000">
                                </div>
                            </div>
