...
<div class="breadcrumb1">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">
                <a href="../bai-viet/kham-pha-nguom-ngao.php">Khám phá Hồ Ba Bể - Thác bản Giốc – Động Ngườm Ngao</a>
            </li>
                        ...
                        <div class="inner">
                            ...
                            <div class="form-row">
                                <div class="form-holder form-holder-2">
                                    ...
                                    <input type="text" placeholder="" class="form-control input-step-2" id="name_tour" value="KHÁM PHÁ ĐÔNG BẮC HÀ NỘI - HỒ BA BỂ - THÁC BẢN GIỐC – ĐỘNG NGƯỜM NGAO">
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-holder form-holder-2">
