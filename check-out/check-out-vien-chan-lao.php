...
<div class="breadcrumb1">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">
                <a href="../bai-viet/chuong-trinh-tham-quan-dat-nuoc-trieu-voi-paksan-vien-chan-luong-prabang-xieng-khoang.php">Đất nước triệu voi - Paksan - Viên Chăn - Xiêng Khoảng</a>
            </li>
                        ...
                        <div class="inner">
                            ...
                            <div class="form-row">
                                <div class="form-holder form-holder-2">
                                    ...
                                    <input type="text" placeholder="" class="form-control input-step-2" id="name_tour" value="CHƯƠNG TRÌNH THAM QUAN ĐẤT NƯỚC TRIỆU VOI PAKSAN – VIÊN CHĂN – LUÔNG PRABANG XIÊNG KHOẢNG">
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-holder form-holder-2">
                            ...
                            <div class="form-row">
                                <div class="form-holder form-holder-2">
                                    <label for="account_number">Mức Gisá:</label>
                                    <input type="text" placeholder="" class="form-control input-step-2-2" id="account_number" name="account_number" value="2890000">
                                </div>
                            </div>
