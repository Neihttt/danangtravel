...
<head>
    ...
    <title>CHƯƠNG TRÌNH DU LỊCH KHÁM PHÁ CAO NGUYÊN MỘC CHÂU
    </title>
...
<body>
    ...
    <div class="container-fluid clearfix">
        <div id="left">
            <div class="breadcrumb1">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Khám phá cao nguyên Mộc Châu</li>
                    </ol>
                </nav>
            </div>
            <div class="title">
                <h4>CHƯƠNG TRÌNH DU LỊCH KHÁM PHÁ CAO NGUYÊN MỘC CHÂU</h4>
            </div>
            ...
            <div class="dat-tour-mobile mt-2">
                <div class="card-body card-menu-1" style="padding: 10px;">
                    ...
                    <div class="card-text" style="font-size: 14px;">
                        ...
                        <div>
                            <a class="order" href="../check-out/check-out-du-lich-cao-nguyen-moc-chau.php" style="color: white;background: #FF8008;background: -webkit-linear-gradient(to right, #FFC837, #FF8008);background: linear-gradient(to right, #FFC837, #FF8008);"><i class="fas fa-cart-plus"></i> Đặt tour</a>
                        </div>
                    </div>
                </div>
            ...
            <div class="tintin">
                <div id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-profile-tab">
                    ...
                    <div class="info-time">
                        <p>
                            <b class="h5">NGÀY 1: HÀ NỘI – MỘC CHÂU ( ĂN: SÁNG, TRƯA, CHIỀU)</b>
                            <p>07h00: Xe ôtô và hướng dẫn viên đón Quý khách tại điểm hẹn khởi hành đi Mộc Châu</p>
                            <p> 11hh00 Đoàn Tới Mộc Châu , dùng bữa trưa tại nhà hàng .Quý khách nhận phòng nghỉ ngơi</p>
                            <p> Chiều: Xe đưa quý khách đi Mộc Châu Sơn La., đoàn vào tham quan Hang Dơi (hay còn gọi là Động Sơn Mộc Hương) – Một tác phẩm nghệ thuật, một danh thắng quốc gia mà thiên nhiên ban tặng cho vùng đất cao nguyên Mộc Châu. Xe đưa đoàn đi tham quan Thác Dải Yếm - Đây là một cảnh quan sinh thái tuyệt đẹp được thiên nhiên ban tặng cho vùng đất Tây Bắc Mộc Châu này. Sau đó, Quý khách tiếp tục đi chiêm ngưỡng vẻ đẹp của Rừng Thông Bản Áng và chụp ảnh lưu niệm trên những đồi hay sườn núi có hoa Mận tím, hoa Đào nở rộ bạt ngàn…</p>
                            <p> Tối: Đoàn ăn tối tại nhà hàng, tự do dạo chơi. Nghỉ đêm tại Mộc Châu.</p>
                            <p style="text-align: center;"><img src="../img/tour/thuong-hai.png" style="width: 650px; height: 390px;">
                                <p style="text-align: center;font-style: italic; color: #333;">Mộc Châu.</p>
                            </p>
                            <b class="h5">NGÀY 2: MỘC CHÂU – HÀ NỘI ( ĂN: SÁNG, TRƯA)</b>
                            <p>Sáng: Đoàn ăn sáng tại khách sạn, lên xe đi tham quan Đồi Chè Mộc Sương, tìm hiểu về cách thu hoạch Chè, quy trình làm Chè Ô Long, thưởng thức và mua đặc sản địa phương: Chè, Sữa, các loại Kẹo…</p>
                            <p>Trưa: Đoàn trả phòng khách sạn, ăn trưa, lên xe về Hà Nội. Về đến điểm hẹn, chia tay Quý khách. Kết thúc chương trình</p>
                            ...
                            <div class="panel" id="two-panel">
                                <div class="info-time">
                                    <p>
                                        ...
                                        - Tàu thuyền thăm quan cô tô con. <br /><br /><br />
        ...
        <div id="right" style="height: 784vh;">
