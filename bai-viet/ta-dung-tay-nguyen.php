...
<head>
    ...
    <title>Tour Tây Nguyên 2N1D: KDL Tà Đùng (Ngủ Lều)</title>
    ...
    <div class="container-fluid clearfix">
        <div id="left">
            <div class="breadcrumb1">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Tour Tây Nguyên 2N1D: KDL Tà Đùng (Ngủ Lều)</li>
                    </ol>
                </nav>
            </div>
            <div class="title">
                <h4>Tour Tây Nguyên 2N1D: KDL Tà Đùng (Ngủ Lều)</h4>
            </div>
            ...
            <div class="under-img">
                ...
                <p style="font-size: 14px; color: red;">Đã có 2 khách đặt trong 24h qua</p>
            </div>
            <div class="dat-tour-mobile mt-2">
                <div class="card-body card-menu-1" style="padding: 10px;">
                    ...
                    <div class="card-text" style="font-size: 14px;">
                        ...
                        <div>
                            <a class="order" href="../check-out/check-out-tay-nguyen-ta-dung.php" style="color: white;background: #FF8008;background: -webkit-linear-gradient(to right, #FFC837, #FF8008);background: linear-gradient(to right, #FFC837, #FF8008);"><i class="fas fa-cart-plus"></i> Đặt tour</a>
                        </div>
                    </div>
                </div>
            ...
            <div class="p">
                <p>
                    Hồ Tà Đùng được ví von với cái tên “vịnh Hạ Long của Tây Nguyên” với khung cảnh nên thơ làm xao xuyến lòng người, vốn là một vùng thung lũng bên núi Tà Đùng, thuộc xã Đắk Som, huyện Đắk G’long, tỉnh Đắk Nông. Khi ngắm nhìn hồ Tà Đùng từ trên cao, chắc rằng quý khách không khỏi ngạc nhiên bởi vẻ đẹp của thiên nhiên với hơn 36 hòn đảo lớn nhỏ, nhấp nhô trên mặt hồ như một mặt gương xanh biếc nổi bật giữa núi rừng Tây Nguyên hoang sơ. Cùng iVIVU khám phá ngay hôm nay!
                </p>
            </div>
            <div id="fb-root"></div>
            ...
            <div class="tintin">
                <div id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-profile-tab">
                    ...
                    <div class="info-time">
                        <p>
                            <b class="h5">NGÀY 1: Đà Nẵng - KHU DU LỊCH TÀ ĐÙNG</b>
                            <p>
                                05h00: Xe và hướng dẫn viên đón đoàn rời TP Đà Nẵng theo QL14 đi Tà Đùng.</p>
                            <p>Quý khách dung điểm tâm sáng.</p>
                            <p>12h00: Đoàn đến KDL Tà Đùng, dùng cơm trưa và nhận lều nghĩ ngơi.</p>
                            <p>Buổi Chiều:</p>
                            <p>Quý khách khám phá KDL Tà Đùng với nhiều điểm check in thú vị và hấp dẫn. Đặc biệt có cơ hội thỏa sức chinh phục “Cầu kính duy nhất tại Tây Nguyên”. Tại đây, du khách có thể cảm nhận được vẻ đẹp hoang sơ tựa bức tranh thiên nhiên tuyệt đẹp ẩn mình dưới ngọn đồi cao su bạt ngàn, cà phê nặng trĩu hạt.
                            </p>
                            <p style="text-align: center;"><img src="../img/tour/ivivu-cau-kinh.gif" style="width: 650px; height: 390px;">
                                <p style="text-align: center;font-style: italic; color: #333;">Cầu Kính Tà Đùng.</p>
                            </p>
                            <p>Quý khách check in tại 1 điểm trên cao, thưởng ngoạn uống café và ngắm cảnh Tà Đùng bao quát. Quý khách phóng tầm nhìn để ngắm khung cảnh kì vĩ tuyệt vời mà thiên nhiên đã ban tặng cho chúng ta.</p>
                            <p style="text-align: center;"><img src="../img/tour/ivivu-ta-dung-dak-nong.gif" style="width: 650px; height: 390px;">
                                <p style="text-align: center;font-style: italic; color: #333;">Dinh Cậu.</p>
                            </p>
                            <p>Đến đây, du khách có thể cảm nhận được vẻ đẹp hoang sơ tựa bức tranh thiên nhiên tuyệt đẹp ẩn mình dưới ngọn đồi cao su bạt ngàn, cà phê nặng trĩu hạt.</p>
                            <p>Nếu đi vào mùa thu hoạch cà phê thì bạn có thể thấy rõ hơn sự nhộn nhịp của người dân khi thời điểm vào mùa tới, khiến nơi đây sống động, đầy ắp tiếng cười đùa của trẻ em cũng như người lớn lan tỏa khắp các sườn đồi.</p>
                            <p>18h30: Quý khách dùng bữa tối tự túc. </p>
                            <p style="text-align: center;"><img src="../img/tour/ivivu-ta-dung-dak-nong.gif" style="width: 650px; height: 390px;">
                                <p style="text-align: center;font-style: italic; color: #333;">Dinh Cậu.</p>
                            </p>
                            ...
                            <p style="text-align: center;"><img src="../img/tour/ivivu-ngu-leu-td.gif" style="width: 650px; height: 390px;">
                                <p style="text-align: center;font-style: italic; color: #333;">Lều tại KDL Tà Đùng.</p>
                            </p>
                            <p>Nghỉ đêm tại lều KDL Tà Đùng.</p>
                            <b class="h5">NGÀY 2 : THAM QUAN KHU VỰC NAM ĐẢO - CÂU CÁ NGẮM SAN HÔ ( ĂN SÁNG, TRƯA, CHIỀU)</b>
                            <p>Buổi sáng: Tà Đùng vào buổi sáng sớm, quý khách có thể săn mây bồng bềnh, thả hồn để tận hưởng cái thi vị mà thiên nhiên đã ban tặng. Nhâm nhi tách cà phê trước cái se lạnh cùng những làn gió rít theo đợt như tăng thêm cái vị đậm đà của tách cà phê núi rừng Tây Nguyên. </p>
                            <p style="text-align: center;"><img src="../img/tour/ivivu-cafe-ngam-ta-dung.gif" style="width: 650px; height: 390px;">
                                <p style="text-align: center;font-style: italic; color: #333;">Dùng bữa sáng ngắm Tà Đùng.</p>
                            </p>
                            <p>06h30: Quý khách tự túc dùng điểm tâm sáng.</p>
                            <p>08h00: Quý khách lên thuyền khám phá Vịnh Hạ Long Tây Nguyên – Khu bảo tồn sinh quyển Tà Đùng, gồm 47 ốc đảo lớn nhỏ với diện tích 22.103 ha, trong đó 86,7% là diện tích rừng xanh bạt ngàn. </p>
                            <p style="text-align: center;"><img src="../img/tour/ivivu-ta-dung-topview-homestay-td.gif" style="width: 650px; height: 390px;">
                                <p style="text-align: center;font-style: italic; color: #333;">"Vịnh Hạ Long" Tây Nguyên.</p>
                            </p>
                            <p>10h00: Đoàn làm thủ tục trả lều, chia tay KDL Tà Đùng. Quý khách lên xe di chuyển đến Kiến Đức - Đak Nông.</p>
                            <p>
                                12h00: khách tự túc dùng buồi trưa tại nhà hàng.
                            </p>
                            13h00: Khởi hành về lại Đà nẵng.
                            <p>18h30: Đến TP.HCM, xe và hướng dẫn viên đưa du khách về điểm hẹn. Kết thúc tour. Chào tạm biệt và hẹn gặp lại! </p>
                    </div>
                </div>
                ...
                <div id="v-pills-contact">
                    ...
                    <div class="info-time">
                        <p>
                            - Phụ thu lều 1 khách: 300.000đ/khách/đêm.<br><br>
                            - Trẻ em vé người lớn, tiêu chuẩn như người lớn.
                        </p>
                    </div>
                    <div class="lich-trinh">
                        <p>Điều khoản</p>
        ...
        <div id="right" style="height: 681vh;">
            <div class="card sticky-top" style="width: 360px; margin-bottom: 10px; margin-top: 5px;">
                <div class="card-body card-menu-1" style="padding: 10px;">
                    <div style="margin-bottom:15px;position:relative;">
                        <div class="b-iamsafe">Điểm đến <span class="hidden-xs">du lịch </span>an toàn</div>
                        <div style="position:absolute;top: 3px;left: 3px;">
