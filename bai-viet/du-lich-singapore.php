...
<head>
    ...
    <title>DU LỊCH SINGAPORE [GARDENS BY THE BAY - MADAME TUSSAUDS - WINGS OF TIME - 01 NGÀY TỰ DO]</title>
    ...
    <div class="container-fluid clearfix">
        <div id="left">
            <div class="breadcrumb1">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">DU LỊCH SINGAPORE</li>
                    </ol>
                </nav>
            </div>
            <div class="title">
                <h4>DU LỊCH SINGAPORE [GARDENS BY THE BAY - MADAME TUSSAUDS - WINGS OF TIME - 01 NGÀY TỰ DO]</h4>
            </div>
            ...
            <div class="under-img">
                ...
                <p style="font-size: 14px; color: red;">Đã có 2 người đặt trong vòng 12h</p>
            </div>
            <div class="dat-tour-mobile mt-2">
                <div class="card-body card-menu-1" style="padding: 10px;">
                    ...
                    <div class="card-text" style="font-size: 14px;">
                        ...
                        <div>
                            <a class="order" href="../check-out/check-out-singaproe.php" style="color: white;background: #FF8008;background: -webkit-linear-gradient(to right, #FFC837, #FF8008);background: linear-gradient(to right, #FFC837, #FF8008);"><i class="fas fa-cart-plus"></i> Đặt tour</a>
                        </div>
                    </div>
                </div>
            ...
            <div class="p">
                <p>
                    - Thưởng lãm những thắng cảnh nổi tiếng Singapore với mức giá tiết kiệm, chất lượng tiêu chuẩn Lữ hành Saigontourist.<br><br>
                    - Khám phá vườn năng lượng với các “siêu cây”; đập nước Marina Barrage - hồ nước nhân tạo lớn khổng lồ ngay giữa trung tâm thành phố.<br><br>
                    - Đặc biệt, thưởng thức chương trình biểu diễn nhạc nước “Wings Of Time” với các tia nước nhảy múa trên nền nhạc cổ điển kết hợp hiện đại…
                </p>
            </div>
            <div id="fb-root"></div>
            ...
            <div class="tintin">
                <div id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-profile-tab">
                    ...
                    <div class="info-time">
                        <p>
                            <b class="h5">NGÀY 1: TP.HCM - SINGAPORE - GARDENS BY THE BAY (Ăn tối)</b>
                            <p>Tập trung tại cổng D2, ga đi Quốc tế - sân bay quốc tế Tân Sơn Nhất, làm thủ tục đáp chuyến bay VJ811 (09:00 - 12:05) đi Singapore, quý khách tự túc bữa ăn trên máy bay.</p>
                            <p> Đến Singapore tham quan Công viên Sư Tử Biển - biểu tượng của Singapore. Chụp hình lưu niệm với nhà hát “Victoria”, Toà nhà Quốc Hội. Tham quan và chụp hình tại Khu vườn năng lượng (Gardens by the Bay) - khu vườn sinh thái đặc biệt với các “siêu cây” năng lượng mặt trời. Nghỉ đêm tại Singapore.</p>
                            <p style="text-align: center;"><img src="../img/tour/Gardens-by-the-Bay_770874520.jpg" style="width: 650px; height: 390px;">
                                <p style="text-align: center;font-style: italic; color: #333;">Khu vườn năng lượng (Gardens by the Bay)</p>
                            </p>
                            <b class="h5">NGÀY 2: SINGAPORE - MADAME TUSSAUDS (Ăn sáng, trưa, tối)</b>
                            <p>Tham quan Đỉnh Faber (Mount Faber), đỉnh cao nhất của đảo quốc và là nơi khởi đầu đường xe cáp sang đảo Sentosa, ngắm toàn cảnh hải cảng, đảo Sentosa và khu vực phía Nam Singapore từ trên cao. </p>
                            <p>Tiếp tục tham quan Đập nước Marina Barrage - hồ nhân tạo đầu tiên nằm giữa trung tâm thành phố với lưu vực 10.000 ha. Mua sắm tại Cửa hàng vàng bạc đá quý và Cửa hàng dầu Habourmart. Khởi hành sang đảo Sentosa, tham quan Bảo tàng tượng sáp Madame Tussauds Singapore - cơ hội tuyệt vời “mặt đối mặt” với những thần tượng bạn yêu mến và Bảo tàng sáp Images of Singapore LIVE để hiểu về lịch sử, văn hóa của Singapore. Thưởng thức Chương trình biểu diễn nhạc nước hết sức độc đáo “WINGS OF TIME” - xem các tia nước nhảy múa trên nền nhạc cổ điển kết hợp hiện đại và tiết mục biểu diễn tia laser. Nghỉ đêm tại Singapore.</p>
                            <p style="text-align: center;"><img src="../img/tour/Madame-Tussauds-Singapore_715654588.jpg" style="width: 650px; height: 390px;">
                                <p style="text-align: center;font-style: italic; color: #333;">Bảo tàng tượng sáp Madame Tussauds Singapore</p>
                            </p>
                            <b class="h5">NGÀY 3: SINGAPORE - 01 NGÀY THAM QUAN TỰ DO (Ăn sáng)</b>
                            <p>Quý khách tự do mua sắm và khám phá Singpore (tự túc ăn uống, tham quan và phương tiện di chuyển. Hướng dẫn viên Lữ hành Saigontourist sẽ hỗ trợ những thông tin du lịch cần thiết). Nghỉ đêm tại Singapore.</p>
                            <b class="h5">NGÀY 4: SINGAPORE - TP.HCM (Ăn sáng)</b>
                            <p>Trả phòng. Ra sân bay Changi làm thủ tục đáp chuyến bay VJ812 (13:05 - 14:10) về Tp.HCM. Quý khách tự túc bữa ăn trên máy bay. Kết thúc chương trình du lịch Singapore.</p>
                    </div>
                </div>
        ...
        <div id="right" style="height: 459vh;">
