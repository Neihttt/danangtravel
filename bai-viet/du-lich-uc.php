...
<head>
    ...
    <title>DU LỊCH ÚC [MELBOURNE - CANBERRA - SYDNEY - CAPTAIN COOK CRUISE]</title>
...
<body>
    ...
    <div class="container-fluid clearfix">
        <div id="left">
            <div class="breadcrumb1">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">DU LỊCH ÚC [MELBOURNE - CANBERRA - SYDNEY - CAPTAIN COOK CRUISE]</li>
                    </ol>
                </nav>
            </div>
            <div class="title">
                <h4>DU LỊCH ÚC [MELBOURNE - CANBERRA - SYDNEY - CAPTAIN COOK CRUISE]</h4>
            </div>
            <img src="../img/tour/Yarra-River_352924970.jpg" />
            <div class="under-img">
                <p class="order" href="../check-out/checkout-thuong-hai-hang-chau-to-chau-bac-kinh.php" style="color: white; margin-right: 20px;">Giảm Giá</p>
                <p style="font-size: 14px; color: red;">Đến 3,000,000 VND</p>
            </div>
            <div class="dat-tour-mobile mt-2">
                <div class="card-body card-menu-1" style="padding: 10px;">
                    ...
                    <div class="card-text" style="font-size: 14px;">
                        ...
                        <div>
                            <a class="order" href="../check-out/check-out-du-lich-uc.php" style="color: white;background: #FF8008;background: -webkit-linear-gradient(to right, #FFC837, #FF8008);background: linear-gradient(to right, #FFC837, #FF8008);"><i class="fas fa-cart-plus"></i> Đặt tour</a>
                        </div>
                    </div>
                </div>
            ...
            <div class="p">
                <p>
                    - Cơ hội tham quan xứ sở chuột túi, đảm bảo chất lượng dịch vụ tốt nhất theo tiêu chuẩn Lữ hành Saigontourist.<br><br>
                    - Thăm Thủ đô Canberra, Melbourne và Thành phố Cảng Sydney danh tiếng; du ngoạn trên tàu ngắm nhìn các biểu tượng của nước Úc: Nhà hát con sò, cầu cảng Sydney…<br><br>
                    - Trải nghiệm độc đáo đi cáp treo qua thung lũng Jaminson, thưởng lãm cảnh đẹp của vườn thực vật Fitzroy Garden, xem tận mắt màn trình diễn cắt xén lông cừu ấn tượng tại nông trại kiểu Úc…
                </p>
            </div>
            <div id="fb-root"></div>
            ...
            <div class="tintin">
                <div id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-profile-tab">
                    ...
                    <div class="info-time">
                        <p>
                            <b class="h5">NGÀY 1: TP.HCM - SINGAPORE - MELBOURNE</b>
                            <p>Quý khách tự túc tập trung tại lầu 2 Ga đi quốc tế - sân bay quốc tế Tân Sơn Nhất, cùng hướng dẫn viên Lữ hành Saigontourist làm thủ tục đáp chuyến bay SQ185 (19:40-22:40) đi Singapore. Đến sân bay Changi, đoàn nối chuyến bay SQ237 (00:25-09:50) đi Melbourne. Ăn nhẹ và nghỉ đêm trên máy bay.</p>
                            <b class="h5">NGÀY 2: KHÁM PHÁ MELBOURNE (Ăn trưa, tối)</b>
                            <p>Tham quan nhà thờ Thánh Patrick cao nhất đất nước được hoàn thành vào năm 1939, chụp hình bên ngoài Tòa nhà Quốc Hội và nhà của Thuyền Trưởng James Cook - người châu Âu đầu tiên tiếp xúc với bờ biển phía Đông nước Úc. Hít thở không khí trong lành và chiêm ngưỡng vẻ đẹp dịu dàng của những tán hoa, bãi cỏ nơi Vườn thực vật Fitzroy. Xe đưa đoàn dạo quanh chiêm ngưỡng Quảng trường Federation, trạm xe lửa trung tâm Flinders - nhà ga xe lửa hơi nước đầu tiên ở Úc và sông Yarra. Nhận phòng khách sạn và nghỉ đêm tại Melbourne.</p>
                            <p style="text-align: center;"><img src="../img/tour/RB-AU-landing-page-1152x648-Melbourne-1.jpg" style="width: 650px; height: 390px;">
                                <p style="text-align: center;font-style: italic; color: #333;">Sông Yarra.</p>
                            </p>
                            <b class="h5">NGÀY 3: MELBOURNE - DANDENONG RANGES - ĐẢO PHILLIP - MELBOURNE (Ăn sáng, trưa, tối)</b>
                            <p>Xe đưa đoàn di chuyển đến khám phá Công viên quốc gia Dandenong Ranges quanh năm mát mẻ với diện tích rộng đến 1900 ha, nơi bảo tồn rất nhiều loài động thực vật quý hiếm. Ăn trưa trong công viên Maru Wildlife, ngắm nhìn vô số động vật yêu quý nhất của Úc: gấu túi koalas, chuột túi nổi tiếng ở Úc và xem màn trình diễn cắt xén lông cừu. Ghé mua sắm và tham quan xưởng sản xuất Chocolate (bên ngoài). Đến Đảo Phillip - thế giới của loài chim cánh cụt ngộ nghĩnh. Quý khách sẽ có dịp trải nghiệm đi trực thăng ngắm cảnh từ trên cao (chi phí tự túc). Nghỉ đêm tại Melbourne.</p>
                            <p style="text-align: center;"><img src="../img/tour/5.png" style="width: 650px; height: 390px;">
                                <p style="text-align: center;font-style: italic; color: #333;">Đảo Phillip</p>
                            </p>
                            <b class="h5">NGÀY 4: MELBOURNE – CANBERRA - SYDNEY (Ăn sáng, trưa, tối)</b>
                            <p>Trả phòng. Xe đưa đoàn ra sân bay đáp chuyến bay sớm đi Canberra - thủ đô trong lành của xứ sở chuột túi. Chiêm ngưỡng bên ngoài Toà nhà Quốc Hội - nơi ngắm toàn cảnh thành phố Canberra từ trên đồi. Tham quan Bảo tàng chiến tranh và Xưởng đúc tiền Hoàng Gia (nếu thời gian cho phép). Quý khách di chuyển về nghỉ đêm tại Sydney.</p>
                            <p style="text-align: center;"><img src="../img/tour/Australian-War-Memorial_187653881.jpg" style="width: 650px; height: 390px;">
                                <p style="text-align: center;font-style: italic; color: #333;">Bảo tàng chiến tranh</p>
                            </p>
                            <b class="h5">NGÀY 5: SYDNEY (Ăn sáng, trưa, tối)</b>
                            <p>Tham quan Công viên Hyde Park, nhà thờ St Mary, Chiếc ghế của Bà Macquarie (Mrs. Macquarie's Chair) - nơi ghi dấu quyền thống trị của nữ hoàng Elizabeth. Ghé chụp hình bên ngoài Nhà hát Con Sò trứ danh và Cầu cảng Sydney - tuyệt tác kĩ thuật băng ngang cảng. Lên du thuyền Captain Cook đi quanh vịnh Sydney, chiêm ngưỡng cầu cảng Sydney ở góc nhìn mới. Buổi chiều, Quý khách tham quan và dạo chơi tại Cảng Darling - "Bến cảng tình yêu" nổi tiếng dành cho các cặp tình nhân. Nghỉ đêm tại Sydney.</p>
                            <p style="text-align: center;"><img src="../img/tour/Yarra-River_352924970.jpg" style="width: 650px; height: 390px;">
                                <p style="text-align: center;font-style: italic; color: #333;">Du thuyền Captain Cook đi</p>
                            </p>
                            <b class="h5">NGÀY 6: SYDNEY - BLUE MOUNTAINS - SYDNEY (Ăn sáng, trưa, tối)</b>
                            <p>Tham quan Vườn quốc gia Blue Mountains - vùng đất trước kia thuộc các bộ tộc thổ dân Úc. Đi cáp treo qua thung lũng, ngắm những thác nước trắng xóa nổi bật trong sắc xanh thiên nhiên hùng vĩ và ngồi xe điện xuống thung lũng Jamison khám phá hệ thực vật còn nguyên sơ tại đây. Quý khách tự do mua sắm. Nghỉ đêm ở Sydney.</p>
                            <p style="text-align: center;"><img src="../img/tour/Blue-Mountains-of--SYDNEY-Australia_597203837.jpg" style="width: 650px; height: 390px;">
                                <p style="text-align: center;font-style: italic; color: #333;">Vườn quốc gia Blue Mountains</p>
                            </p>
                            <b class="h5">NGÀY 7: SYDNEY - SINGAPORE - TP.HCM</b>
                            <p>Trả phòng. Ra sân bay, làm thủ tục chuyến bay SQ212 (07:55-14:15) đi Singapore. Đến sân bay Changi, nối chuyến bay SQ186 (17:25-18:35) về Tp.HCM. Kết thúc chương trình.</p>
                    </div>
                </div>
                ...
                <div id="v-pills-contact">
                    ...
                    <div class="info-time">
                        <p>
                            - Phụ thu phòng đơn: 2.600.000 vnd/1 khách.<br><br>
        ...
        <div id="right" style="height: 637vh;">
