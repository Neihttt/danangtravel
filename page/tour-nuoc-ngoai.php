...
<head>
    ...
    <title>Tour Du Lịch Nước Ngoài - DANANG TRAVEL</title>
            ...
            <div class="breadcrumb1">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Tour nước ngoài</li>
                    </ol>
                </nav>
            </div>
            <div class="panel">
                <div class="title-header">Địa điểm HOT nước ngoài</div>
                <a href="#" style="text-decoration: none;">
                    <div class="content-panel">Thái Lan</div>
                </a>
                <a href="#" style="text-decoration: none;">
                    <div class="content-panel">Campuchia</div>
                </a>
                <a href="#" style="text-decoration: none;">
                    <div class="content-panel">Nhật Bản</div>
                </a>
                <a href="#" style="text-decoration: none;">
                    <div class="content-panel">Hàn Quốc</div>
                </a>
                <a href="#" style="text-decoration: none;">
                    <div class="content-panel">Myanmar</div>
                </a>
                <a href="#" style="text-decoration: none;">
                    <div class="content-panel">Châu Âu</div>
                </a>
                <a href="#" style="text-decoration: none;">
                    <div class="content-panel">Đài Loan</div>
                </a>
                <a href="#" style="text-decoration: none;">
                    <div class="content-panel">Trung Quốc</div>
                </a>
            </div>
        </div>
        <div id="main" class="truncate">
            ...
            <div id="left" data-aos="fade-right" data-aos-delay="50">
                ...
                <div class="img-header">
                    <img src="../img/trangchu/travel5.jpg">
                </div>
                <div class="p">
                    <a href="../bai-viet/chuong-trinh-tour-trung-quoc-thuong-hai-hang-chau-to-chau-bac-kinh.php" style="text-decoration: none; color: black;">
                        <h3>
                            CHƯƠNG TRÌNH TOUR TRUNG QUỐC THƯỢNG HẢI – HÀNG CHÂU – TÔ CHÂU – BẮC KINH</h3>
                    </a>
                ...
                <div class="rate-tour">
                    ...
                    <p class="p1-fix-rate" style="text-decoration: line-through;">16,990,000VND</p>
                    <p class="p1">13,990,000<font style="font-size: 70%; margin-left: 5px;">VND</font>
                    </p>
                </div>
            </div>
            <div id="left" data-aos="fade-right" data-aos-delay="200">
                <div class="img-header">
                    <img src="../img/trangchu/travel6.jpg">
                </div>
                <div class="p">
                    <a href="../bai-viet/bac-kinh-tu-cam-thanh-thien-an-mon-thien-dan-van-ly-truong-thanh.php" style="text-decoration: none; color: black;">
                        <h3>
                            BẮC KINH – TỬ CẤM THÀNH – THIÊN AN MÔN – THIÊN ĐÀN – VẠN LÝ TRƯỜNG THÀNH</h3>
                    </a>
                    <p>Nhà cung cấp dịch vụ: <b>Liên Minh</b></p>
                    <p>Thời gian: 4 ngày – 3 đêm , phương tiện : ô tô</p>
                </div>
                <div class="rate-tour">
                    <p><i class="fas fa-phone-volume"></i> 0915.843.635 </p>
                    <p><i class="fas fa-info"></i> Ms Phương Anh</p>
                    <p class="p1">9,990,000<font style="font-size: 70%; margin-left: 5px;">VND</font>
                    </p>
                </div>
            </div>
            <div id="left" data-aos="fade-right" data-aos-delay="300">
                <span class="ribbon text-center font-weight-bold">
                    <p class="ribbon-text">Tour mới</p>
                </span>
                <div class="img-header">
                    <img src="../img/trangchu/travel7.png">
                </div>
                <div class="p">
                    <a href="../bai-viet/chuong-trinh-tham-quan-dat-nuoc-trieu-voi-paksan-vien-chan-luong-prabang-xieng-khoang.php" style="text-decoration: none; color: black;">
                        <h3>
                            CHƯƠNG TRÌNH THAM QUAN ĐẤT NƯỚC TRIỆU VOI PAKSAN – VIÊN CHĂN – XIÊNG KHOẢNG</h3>
                    </a>
                    <p>Nhà cung cấp dịch vụ: <b>Liên Minh</b></p>
            ...
            <div id="left" data-aos="fade-right" data-aos-delay="400">
                ...
                <div class="p">
                    <a href="../bai-viet/du-lich-uc.php" style="text-decoration: none; color: black;">
                        <h3>
                            DU LỊCH ÚC [MELBOURNE - CANBERRA - SYDNEY - CAPTAIN COOK CRUISE]</h3>
                    </a>
                    <p>Nhà cung cấp dịch vụ: <b>Liên Minh</b></p>
                ...
                <div class="rate-tour">
                    <p><i class="fas fa-phone-volume"></i> 0915.843.635 </p>
                    <p><i class="fas fa-info"></i> Ms Phương Anh</p>
                    <p class="p1">48,990,000<font style="font-size: 70%; margin-left: 5px;">VND</font>
                    </p>
                </div>
            </div>
            <div id="left" data-aos="fade-right" data-aos-delay="500">
                ...
                <div class="p">
                    <a href="../bai-viet/du-lich-singapore.php" style="text-decoration: none; color: black;">
                        <h3>
                            DU LỊCH SINGAPORE [GARDENS BY THE BAY - MADAME TUSSAUDS - WINGS OF TIME - 01 NGÀY TỰ DO]</h3>
                    </a>
                    <p>Nhà cung cấp dịch vụ: <b>Liên Minh</b></p>
                ...
                <div class="rate-tour">
                    <p><i class="fas fa-phone-volume"></i> 0915.843.635 </p>
                    <p><i class="fas fa-info"></i> Ms Phương Anh</p>
                    <p class="p1">11,990,000<font style="font-size: 70%; margin-left: 5px;">VND</font>
                    </p>
                </div>
            </div>
            <div id="left" data-aos="fade-right" data-aos-delay="150">
                <div class="img-header">
                    <img src="../img/tour/Fifth-Avenue_668246224.jpg">
                </div>
                <div class="p">
                    <a href="../bai-viet/du-lich-my-bo-dong.php" style="text-decoration: none; color: black;">
                        <h3>
                            DU LỊCH MỸ - BỜ ĐÔNG [NEW YORK - PHILADELPHIA - WASHINGTON D.C]</h3>
                    </a>
                    <p>Nhà cung cấp dịch vụ: <b>Liên Minh</b></p>
                ...
                <div class="rate-tour">
                    <p><i class="fas fa-phone-volume"></i> 0915.843.635 </p>
                    <p><i class="fas fa-info"></i> Ms Phương Anh</p>
                    <p class="p1">57,990,000<font style="font-size: 70%; margin-left: 5px;">VND</font>
                    </p>
                </div>
            </div>
        </div>
