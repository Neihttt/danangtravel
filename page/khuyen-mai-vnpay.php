            ...
            <div class="tintin">
                <div id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-profile-tab">
                    <div class="lich-trinh">
                        <p>Giảm 5% tối đa 100.000đ khi nhập mã “VTR”</p>
                    </div>
                    <div class="info-time" id="info-time">
                        <p>
                            - Thời gian: từ 1/6 - 31/7/2020<br />
                            - Nội dung: giảm 5% tối đa 100.000đ/sđt/lần.<br />
                            - Phạm vi áp dụng: trụ sở chính và các chi nhánh Vietravel trên toàn quốc.<br />
                            - Cách thức: khách hàng nhập mã VTR vào ô “mã giảm giá” trên màn hình giao diện Smart banking có tích hợp tính năng thanh toán QrCode VnPay<br />
                            - Áp dụng cho 1000 giao dịch đầu tiên. <br />
                            - Giá trị ưu đãi sẽ được làm tròn theo đơn vị: nghìn đồng. Cụ thể
                            <500 đồng làm tròn xuống 0đ; ≥500đ làm tròn lên 1.000đ<br />
                            - Mỗi khách hàng đi tour sẽ được hưởng 1 lần ưu đãi trong suốt chương trình. <br />
                            - Tiền ưu đãi sẽ được trừ trực tiếp vào tài khoản của khách hàng.<br />
                            - Các ngân hàng có áp dụng thanh toán bằng VNPAY<br />
                            <br />
                    </div>
                    <div style="width: 660px; height: 400px;">
                        <img src="../img/tour/vnpay.jpg">
                    </div>
                </div>
